You are updating the yaarwinapp.co repository.
...
4. Preserve existing HTML/CSS style, SEO metadata, schema patterns, internal links, and soft YaarWin registration CTAs.
